package com.istudy.song.controller;

import com.alibaba.fastjson.JSONObject;
import com.istudy.song.pojo.Song;
import com.istudy.song.sevice.impl.SongServiceImpl;
...
public class SongController {
    ...
    public class MyPicConfig implements WebMvcConfigurer {
        ...
        public void addResourceHandlers(ResourceHandlerRegistry registry) {
            registry.addResourceHandler("/img/songPic/**").addResourceLocations("file:D:/桌面/music-website-master/music-server/img/songPic/");
            registry.addResourceHandler("/song/**").addResourceLocations("file:D:/桌面/music-website-master/music-server/song/");
        }
    }
